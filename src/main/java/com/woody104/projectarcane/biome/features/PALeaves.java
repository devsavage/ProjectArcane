...
public class PALeaves extends BlockLeaves
{

    public static final String[][] leafTypes = new String[][] {{"LeafMaple", "LeafGreenApple"}, {"LeafMapleOpaque", "LeafGreenAppleOpaque"}};
