...
public class PALog extends BlockLog
{
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        for (int i = 0; i < this.field_150167_a.length; i++) {
            this.field_150167_a[i] = iconRegister.registerIcon(Arcane.MODID + ":" + this.getUnlocalizedName().substring(5) + logs[i]);
            this.field_150166_b[i] = iconRegister.registerIcon(Arcane.MODID + ":" + this.getUnlocalizedName().substring(5) + logs[i] + "Top");
        }
    }
}
