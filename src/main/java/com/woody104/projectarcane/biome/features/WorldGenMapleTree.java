...
public class WorldGenMapleTree extends WorldGenAbstractTree
{
    ...
    public WorldGenMapleTree(Block wood, Block leaves, int metaWood, int metaLeaves, boolean doBlockNotify, int minTreeHeight, int randomTreeHeight, boolean vinesGrow)
    {
        super(doBlockNotify);
        this.wood = wood;
        this.leaves = leaves;
