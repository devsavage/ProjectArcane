...
public class ArcaneTableCraftingManager
{
    ...
    private ArcaneTableCraftingManager() {
      ...
      //MY RECIPES
      this.addRecipe(new ItemStack(Arcane.foodGreenApple, 1), new Object[] {"NNN ", "NAN ", "NNN ", "    ", 'N', Arcane.emeraldNugget, 'A', Items.apple });
      this.addRecipe(new ItemStack(Arcane.foodGreenApple, 1), new Object[] {" NNN", " NAN", " NNN", "    ", 'N', Arcane.emeraldNugget, 'A', Items.apple });
      this.addRecipe(new ItemStack(Arcane.foodGreenApple, 1), new Object[] {"    ", "NNN ", "NAN ", "NNN ", 'N', Arcane.emeraldNugget, 'A', Items.apple });
      this.addRecipe(new ItemStack(Arcane.foodGreenApple, 1), new Object[] {"    ", " NNN", " NAN", " NNN", 'N', Arcane.emeraldNugget, 'A', Items.apple });
      this.addRecipe(new ItemStack(Arcane.toolSaw, 1), new Object[] {"PPPS", "P  S", "IIIS", "    ", 'P', Blocks.planks, 'S', Items.stick, 'I', Items.iron_ingot});
		...
		this.addRecipe(new ItemStack(Arcane.itemArcaneGem), " Y ", "XZX", " Y ", 'X', Items.diamond , 'Y', Items.emerald, 'Z',(new ItemStack(Items.dye, 1, 14)));
		this.addRecipe(new ItemStack(Arcane.blockArcaneGem), "XXX", "XXX", "XXX", 'X', Arcane.itemArcaneGem);
      this.addRecipe(new ItemStack(Arcane.blockMachineCore), "XXX ", "X  X", "XXX ", "    ", 'X', Arcane.itemArcaneMetal);
      this.addRecipe(new ItemStack(Arcane.blockArcaneFurnaceIdle), "XXX", "XMX", "XXX", 'X', Arcane.ArcanePlate, 'M', Arcane.blockMachineCore);
      this.addRecipe(new ItemStack(Arcane.itemChainIngot), "LLL", "LLL", "   ", 'L', Arcane.itemChainLink);
      this.addRecipe(new ItemStack(Arcane.itemChainIngot), "   ", "LLL", "LLL", 'L', Arcane.itemChainLink);
      this.addRecipe(new ItemStack(Blocks.double_plant, 1, 0), " X ", "XXX", " X ", 'X', Blocks.yellow_flower);
      this.addShapelessRecipe(new ItemStack(Arcane.itemChainLink, 1), Arcane.itemArcaneMetal, new ItemStack(Arcane.toolArcaneChisel, 1, OreDictionary.WILDCARD_VALUE));
		this.addShapelessRecipe(new ItemStack(Arcane.itemArcaneGem, 9), new ItemStack(Arcane.blockArcaneGem));
      this.addShapelessRecipe(new ItemStack(Arcane.itemArcaneMetal, 1), Blocks.stone, Items.iron_ingot, new ItemStack(Arcane.toolArcaneHammer, 1, OreDictionary.WILDCARD_VALUE));
      this.addShapelessRecipe(new ItemStack(Arcane.foodSunflowerSeeds, 4), Items.wheat_seeds, new ItemStack(Blocks.double_plant, 1, 0));
		this.addRecipe(new ItemStack(Items.string, 4), new Object[]{"IH", 'I', Blocks.wool, 'H', new ItemStack(Arcane.itemCutter, 1, OreDictionary.WILDCARD_VALUE)});
		this.addRecipe(new ItemStack(Arcane.itemArcaneMetalPlate), new Object[]{"IH", 'I', Arcane.itemArcaneMetal, 'H', new ItemStack(Arcane.toolArcaneHammer, 1, OreDictionary.WILDCARD_VALUE)});
      this.addRecipe(new ItemStack(Arcane.emeraldNugget, 9), new Object[]{"CB", 'B', Blocks.emerald_block, 'C', new ItemStack(Arcane.toolArcaneChisel, 1, OreDictionary.WILDCARD_VALUE)});
      this.addRecipe(new ItemStack(Arcane.ArcanePlate, 1), new Object[]{"CB", 'B', Arcane.itemArcaneGem, 'C', new ItemStack(Arcane.toolArcaneHammer, 1, OreDictionary.WILDCARD_VALUE)});
      this.addShapelessRecipe(new ItemStack(Arcane.itemWoodChips, 4), Blocks.planks, new ItemStack(Arcane.toolSaw, 1, OreDictionary.WILDCARD_VALUE));
		this.addRecipe(new ItemStack(Arcane.arcaneAxe), " XX", " YX", " Y ", 'X', Arcane.itemArcaneGem, 'Y', Items.stick);
		this.addRecipe(new ItemStack(Arcane.arcaneAxe), "XX ", "XY ", " Y ", 'X', Arcane.itemArcaneGem, 'Y', Items.stick);
		this.addRecipe(new ItemStack(Arcane.arcaneSword), " X ", " X ", " Y ", 'X', Arcane.itemArcaneGem, 'Y', Items.stick);
		this.addRecipe(new ItemStack(Arcane.arcanePickaxe), "XXX", " Y ", " Y ", 'X', Arcane.itemArcaneGem, 'Y', Items.stick);
		this.addRecipe(new ItemStack(Arcane.arcaneSpade), " X ", " Y ", " Y ", 'X', Arcane.itemArcaneGem, 'Y', Items.stick);
		this.addRecipe(new ItemStack(Arcane.arcaneHoe), " XX", " Y ", " Y ", 'X', Arcane.itemArcaneGem, 'Y', Items.stick);
		this.addRecipe(new ItemStack(Arcane.arcaneHoe), "XX ", " Y ", " Y ", 'X', Arcane.itemArcaneGem, 'Y', Items.stick);
		this.addRecipe(new ItemStack(Arcane.ToolDarkCrystalAxe), " XX", " YX", " Y ", 'X', Arcane.itemDarkCrystal, 'Y', Items.stick);
		this.addRecipe(new ItemStack(Arcane.ToolDarkCrystalAxe), "XX ", "XY ", " Y ", 'X', Arcane.itemDarkCrystal, 'Y', Items.stick);
		this.addRecipe(new ItemStack(Arcane.ToolDarkCrystalSword), " X ", " X ", " Y ", 'X', Arcane.itemDarkCrystal, 'Y', Items.stick);
		this.addRecipe(new ItemStack(Arcane.ToolDarkCrystalPickaxe), "XXX", " Y ", " Y ", 'X', Arcane.itemDarkCrystal, 'Y', Items.stick);
		this.addRecipe(new ItemStack(Arcane.ToolDarkCrystalSpade), " X ", " Y ", " Y ", 'X', Arcane.itemDarkCrystal, 'Y', Items.stick);
		this.addRecipe(new ItemStack(Arcane.ToolDarkCrystalHoe), " XX", " Y ", " Y ", 'X', Arcane.itemDarkCrystal, 'Y', Items.stick);
		this.addRecipe(new ItemStack(Arcane.ToolDarkCrystalHoe), "XX ", " Y ", " Y ", 'X', Arcane.itemDarkCrystal, 'Y', Items.stick);
		this.addRecipe(new ItemStack(Arcane.DirtAxe), " XX", " YX", " Y ", 'X', Blocks.dirt, 'Y', Arcane.DirtStick);
		this.addRecipe(new ItemStack(Arcane.DirtAxe), "XX ", "XY ", " Y ", 'X', Blocks.dirt, 'Y', Arcane.DirtStick);
		this.addRecipe(new ItemStack(Arcane.DirtSword), " X ", " X ", " Y ", 'X', Blocks.dirt, 'Y', Arcane.DirtStick);
		this.addRecipe(new ItemStack(Arcane.DirtPickaxe), "XXX", " Y ", " Y ", 'X', Blocks.dirt, 'Y', Arcane.DirtStick);
		this.addRecipe(new ItemStack(Arcane.DirtSpade), " X ", " Y ", " Y ", 'X', Blocks.dirt, 'Y', Arcane.DirtStick);
		this.addRecipe(new ItemStack(Arcane.DirtHoe), " XX", " Y ", " Y ", 'X', Blocks.dirt, 'Y', Arcane.DirtStick);
		this.addRecipe(new ItemStack(Arcane.DirtHoe), "XX ", " Y ", " Y ", 'X', Blocks.dirt, 'Y', Arcane.DirtStick);
		this.addRecipe(new ItemStack(Arcane.itemThunderfury), " XX", "ZYX", "ZZ ", 'X',(new ItemStack(Items.dye, 1, 4)), 'Y', Items.emerald, 'Z', Arcane.itemArcaneGem);
		this.addRecipe(new ItemStack(Arcane.arcaneHelmet), "XXX", "X X", "   ", 'X', Arcane.itemArcaneGem);
		this.addRecipe(new ItemStack(Arcane.arcaneChestplate), "X X", "XXX", "XXX", 'X', Arcane.itemArcaneGem);
		this.addRecipe(new ItemStack(Arcane.arcaneLeggings), "XXX", "X X", "X X", 'X', Arcane.itemArcaneGem);
		this.addRecipe(new ItemStack(Arcane.arcaneBoots), "   ", "X X", "X X", 'X', Arcane.itemArcaneGem);
		this.addRecipe(new ItemStack(Arcane.BoneHelmet), "XXX", "X X", "   ", 'X', Items.bone);
		this.addRecipe(new ItemStack(Arcane.BoneChestplate), "X X", "XXX", "XXX", 'X', Items.bone);
		this.addRecipe(new ItemStack(Arcane.BoneLeggings), "XXX", "X X", "X X", 'X', Items.bone);
		this.addRecipe(new ItemStack(Arcane.BoneBoots), "   ", "X X", "X X", 'X', Items.bone);
		this.addRecipe(new ItemStack(Arcane.DarkCrystalHelmet), "XXX", "X X", "   ", 'X', Arcane.itemDarkCrystal);
      this.addRecipe(new ItemStack(Arcane.DarkCrystalChestplate), "X X", "XXX", "XXX", 'X', Arcane.itemDarkCrystal);
      this.addRecipe(new ItemStack(Arcane.DarkCrystalLeggings), "XXX", "X X", "X X", 'X', Arcane.itemDarkCrystal);
      this.addRecipe(new ItemStack(Arcane.DarkCrystalBoots), "   ", "X X", "X X", 'X', Arcane.itemDarkCrystal);
      this.addRecipe(new ItemStack(Items.chainmail_helmet), "XXX", "X X", "   ", 'X', Arcane.itemChainIngot);
      this.addRecipe(new ItemStack(Items.chainmail_chestplate), "X X", "XXX", "XXX", 'X', Arcane.itemChainIngot);
      this.addRecipe(new ItemStack(Items.chainmail_leggings), "XXX", "X X", "X X", 'X', Arcane.itemChainIngot);
      this.addRecipe(new ItemStack(Items.chainmail_boots), "   ", "X X", "X X", 'X', Arcane.itemChainIngot);
      this.addRecipe(new ItemStack(Arcane.arcaneChest), "XXX", "X X", "XXX", 'X', Arcane.itemArcaneGem);
		this.addRecipe(new ItemStack(Arcane.toolArcaneHammer), new Object[]{"XXX", "XSX", " S ", 'X', Arcane.itemArcaneGem, 'S', Items.stick});
      this.addRecipe(new ItemStack(Arcane.toolArcaneChisel), new Object[]{"  X", "GX ", "GG ", 'X', Arcane.itemArcaneRod, 'G', Arcane.itemArcaneGem});
		this.addShapelessRecipe(new ItemStack(Items.string, 4), new ItemStack(Arcane.itemCutter), new ItemStack(Blocks.wool));
		this.addRecipe(new ItemStack(Arcane.itemMetalBender), "XXX", "YYY", "XXX", 'X', Arcane.itemArcaneMetalPlate, 'Y', Arcane.itemArcaneGem);
		this.addShapelessRecipe(new ItemStack(Arcane.itemHandle, 1), new ItemStack(Arcane.itemMetalBender), new ItemStack(Arcane.itemArcaneMetalPlate));
		this.addShapelessRecipe(new ItemStack(Arcane.itemCutter, 1), new ItemStack(Arcane.itemHandle), new ItemStack(Arcane.itemBlades));
		this.addRecipe(new ItemStack(Arcane.itemEnhancedArcaneMetal), " XX", " XX", "   ", 'X', Arcane.itemArcaneMetalPlate);
		this.addRecipe(new ItemStack(Arcane.itemEnhancedArcaneMetal), "XX ", "XX ", "   ", 'X', Arcane.itemArcaneMetalPlate);
		this.addRecipe(new ItemStack(Arcane.itemEnhancedArcaneMetal), " XX", " XX", "   ", 'X', Arcane.itemArcaneMetalPlate);
		this.addRecipe(new ItemStack(Arcane.itemEnhancedArcaneMetal), "   ", "XX ", "XX ", 'X', Arcane.itemArcaneMetalPlate);
		this.addRecipe(new ItemStack(Arcane.DirtStick), "   ", " X ", " X ", 'X', Blocks.dirt);
		this.addRecipe(new ItemStack(Arcane.DirtStick), " X ", " X ", "   ", 'X', Blocks.dirt);
		this.addRecipe(new ItemStack(Items.emerald), "XXX", "XXX", "XXX", 'X', Arcane.emeraldNugget); 
		this.addRecipe(new ItemStack(Arcane.foodGreenApple), "XXX", "XYX", "XXX", 'X', Items.emerald, 'Y', Items.apple);
		this.addRecipe(new ItemStack(Arcane.itemCoalChunk), new Object[]{"XX ", "XX ",'X', Items.coal});
		this.addRecipe(new ItemStack(Arcane.itemCoalChunk), new Object[]{" XX", " XX",'X', Items.coal});
		this.addRecipe(new ItemStack(Arcane.itemCoalChunk), new Object[]{"XX ", "XX", 'X', Items.coal});
		this.addRecipe(new ItemStack(Arcane.itemCoalChunk), new Object[]{" XX", " XX", 'X', Items.coal});
		this.addShapelessRecipe(new ItemStack(Arcane.itemCoalChunk), Blocks.coal_block, new ItemStack(Arcane.toolArcaneChisel, 1, OreDictionary.WILDCARD_VALUE));
		this.addShapelessRecipe(new ItemStack(Arcane.itemCobaltPlate), Arcane.itemCobaltIngot, new ItemStack(Arcane.toolGoldHammer, 1, OreDictionary.WILDCARD_VALUE));
      //MINECRAFT RECIPES
