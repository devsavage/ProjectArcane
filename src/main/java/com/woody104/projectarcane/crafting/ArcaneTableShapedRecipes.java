...
public class ArcaneTableShapedRecipes implements IRecipe
{
    ...
    public ArcaneTableShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public ArcaneTableShapedRecipes func_92100_c()
    {
