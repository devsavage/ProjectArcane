...
import tv.savageboy74.projectarcane.armor.arcaneArmor;
import tv.savageboy74.projectarcane.armor.boneArmor;
import tv.savageboy74.projectarcane.armor.darkCrystalArmor;
import tv.savageboy74.projectarcane.food.FoodCookedChickenLeg;
import tv.savageboy74.projectarcane.food.FoodGreenApple;
import tv.savageboy74.projectarcane.food.FoodRawChickenLeg;
import tv.savageboy74.projectarcane.food.FoodSunflowerSeeds;
import tv.savageboy74.projectarcane.items.*;
import tv.savageboy74.projectarcane.util.Reference;
import net.minecraft.init.Blocks;
import net.minecraft.item.Item;
import net.minecraft.item.ItemFood;
import net.minecraft.item.ItemSeeds;
import tv.savageboy74.projectarcane.tools.*;
...
//    public static Item DirtSpade = new DirtSpade(MaterialRegistry.Tools.dirt).setUnlocalizedName("dirtSpade").setTextureName(Reference.MOD_ID + ":" + "dirt_shovel");
